...
Currently exploring cloud deployment and learning Go.
...
**Languages:** Python, JavaScript, C#, Java, C (learning Go)
**Backend:** FastAPI, Node.js, Express, WebSockets
**Frontend:** React
**ML/Data:** scikit-learn, TensorFlow, SHAP, pandas
**Tools:** Git, GitHub Actions, UNIX CLI, VS Code
...
- Cellular automata engine modelling wildfire spread using real Queensland elevation
  and vegetation data
- Live state updates streamed to a React frontend via WebSocket
- **Stack:** Python, FastAPI, WebSockets, React
...
- REST API built with FastAPI, consumed by a React frontend
